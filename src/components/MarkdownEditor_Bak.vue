...
//    })
  ...
  beforeDestroy() {
    this.input.removeEventListener("input", this.debounce(this.compileMarkdownAndRender, 100));
    this.input.removeEventListener("scroll", this.handleInputScroll);
    this.output.removeEventListener("scroll", this.handleOutputScroll);
    this.input = null;
    this.output = null;
  },
  methods: {
